...
#define GPIOC_PIN2                  2
#define GPIOC_PIN3                  3
#define GPIOC_DW_IRQ                4
#define GPIOC_DW_RST                5
#define GPIOC_LED2                  6
#define GPIOC_LED3                  7
#define GPIOC_LED1           8
...
#define VAL_GPIOC_MODER    (PIN_MODE_OUTPUT(GPIOC_LED_ERR) |         \
                            ...
                            PIN_MODE_INPUT(GPIOC_DW_IRQ) |       \
                            PIN_MODE_OUTPUT(GPIOC_DW_RST) |             \
...
#define VAL_GPIOC_OTYPER   (PIN_OTYPE_PUSHPULL(GPIOC_LED_ERR) |      \
                            ...
                            PIN_OTYPE_PUSHPULL(GPIOC_DW_IRQ) |    \
                            PIN_OTYPE_OPENDRAIN(GPIOC_DW_RST) |         \
...
#define VAL_GPIOC_OSPEEDR  (PIN_OSPEED_2M(GPIOC_LED_ERR) |           \
                            ...
                            PIN_OSPEED_2M(GPIOC_DW_IRQ) |         \
                            PIN_OSPEED_2M(GPIOC_DW_RST) |            \
...
#define VAL_GPIOC_ODR      (PIN_ODR_HIGH(GPIOC_LED_ERR) |            \
                            ...
                            PIN_ODR_HIGH(GPIOC_DW_IRQ) |          \
                            PIN_ODR_HIGH(GPIOC_DW_RST) |               \
...
#define VAL_GPIOC_AFRL     (PIN_AFIO_AF(GPIOC_LED_ERR, 0) |          \
                            ...
                            PIN_AFIO_AF(GPIOC_DW_IRQ, 0) |        \
                            PIN_AFIO_AF(GPIOC_DW_RST, 0) |             \
                            PIN_AFIO_AF(GPIOC_LED2, 0) |      \
                            PIN_AFIO_AF(GPIOC_LED3, 0))

#define VAL_GPIOC_AFRH     (PIN_AFIO_AF(GPIOC_LED1, 0) |      \
                            PIN_AFIO_AF(GPIOC_ENGINE_PWM5, 0) |      \
